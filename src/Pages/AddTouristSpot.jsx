  ...
  return (
    <div>
      <form
        ...
        className="min-h-[calc(100vh-300px)] flex bg-[#FFD586] rounded-2xl my-12 justify-center items-center"
      >
        <fieldset className="fieldset  bg-transparent grow  max-w-7xl  p-18 grid  grid-cols-2 gap-12">
          <div className="flex flex-col ">
            ...
            <input
              ...
              className="input border-none  w-3/4"
            />
            ...
            <input
              type="text"
              name="image"
              className="input w-3/4 border-none"
            />
          ...
          <div className="flex flex-col">
            ...
            <input
              type="text"
              name="description"
              className="input  w-3/4 border-none py-8 md:py-16"
            />
          </div>

          <input
            className="col-span-2 btn btn-neutral"
            type="submit"
            value="Add spot"
          />
        </fieldset>
